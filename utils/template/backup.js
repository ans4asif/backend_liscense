      ...
      <div class="container">
        <div class="breakable-div">
          ...
          <div class="flex-wrap">
            <div class="field-box">
              ...
              <span class="field-text">${moment(data.issue_date).format('DD-MMM-YYYY')}</span>
            </div>
            <div class="field-box">
              <span class="label">Expiry Date:</span>
              <span class="field-text">${moment(data.expiry_date).format('DD-MMM-YYYY')}</span>
            </div>
            <div class="field-box">
              <span class="label">Date of Birth:</span>
              <span class="field-text">${moment(data.dob).format('DD-MMM-YYYY')}</span>
            </div>
          </div>
        ...
        <div class="breakable-div">
          <div class="page-header" style="margin-bottom: 0; margin-top: 20px  !important;">
            <h1>LICENCE 2 DRIVE</h1>
            <div class="text-box" style="margin-bottom: 0; margin-top: -8px  !important;">
              <p>ANSWER SHEET</p>
            </div>
          </div>
          
          <span class="grey-line"></span>
          <div class="flex-wrap" style="margin-bottom: -10px !important;">
            <div class="field-box">
              <span class="label">Name:</span>
              <span class="field-text">${data.full_name}</span>
            </div>
...
<div class="flex-wrap">
          <div class="field-box">
            ...
            <span class="field-text">${data.course_start_date ? moment(data.course_start_date).format('DD-MMM-YYYY') : '&nbsp;'}</span>
          </div>
          <div class="field-box">
<span class="label">COURSE END DATE:</span>
            <span class="field-text">${data.course_end_date ? moment(data.course_end_date).format('DD-MMM-YYYYYY')  : '&nbsp;'}</span>
</div>
        </div>
<div class="flex-wrap">
          <div class="field-box">
        ...
        <div class="flex-wrap">
          <table class="unstyledTable styled2 tdSize" style="margin: 30px 0">
            ...
            <tbody>
              <tr>
                <td>&nbsp;SESSION # 1</td>
                <td>&nbsp; ${data.session_1_date ? moment(data.session_1_date).format('DD-MMM-YYYY') : '&nbsp;' }</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;SESSION # 2</td>
                <td>&nbsp; ${data.session_2_date ? moment(data.session_2_date).format('DD-MMM-YYYY') : '&nbsp;' }</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;SESSION # 3</td>
                <td>&nbsp;${data.session_3_date ? moment(data.session_3_date).format('DD-MMM-YYYY') : '&nbsp;' }</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;SESSION # 4</td>
                <td>&nbsp;${data.session_4_date ? moment(data.session_4_date).format('DD-MMM-YYYY') : '&nbsp;' }</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;SESSION # 5</td>
                <td>&nbsp;${data.session_5_date ? moment(data.session_5_date).format('DD-MMM-YYYY') : '&nbsp;' }</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;SESSION # 6</td>
                <td>&nbsp;${data.session_6_date ? moment(data.session_6_date).format('DD-MMM-YYYY') : '&nbsp;' }</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              </tr>
            </tbody>
...
<div class="flex-wrap">
          <div class="field-box">
            <span class="label">IN CLASS INSTRUCTOR'S:</span>
            <span class="field-text">&nbsp;</span>
<span class="abs-text" style="left: 74% !important">SIGNATURE</span>
          </div>
          <div class="field-box">
<span class="label">INSTRUCTOR LICENCE NO:</span>
            <span class="field-text">&nbsp;</span>
</div>
        </div>
        <div class="flex-wrap">
          <div class="field-box">
            <span class="label">INSTRUCTOR LICENCE EXPIRY:</span>
            <span class="field-text"> ${data.inst_lic_expiry ? data.inst_lic_expiry : '&nbsp;' }</span>
          </div>
        </div>
